...
log_level = 'INFO'
load_from = 'http://download.openmmlab.com/mmdetection/v2.0/hrnet/htc_hrnetv2p_w32_20e_coco/htc_hrnetv2p_w32_20e_coco_20200207-7639fa12.pth'
resume_from = None
workflow = [('train', 1)]
...
work_dir = '/kaggle/working/htc_hrnetv2p_w32_10e_chulacell'
auto_resume = False
gpu_ids = range(0, 2)